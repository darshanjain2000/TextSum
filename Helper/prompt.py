class Prompt:
    ...
    def generate_column_summary(self, active_approach, data_array, previous_summary, quant_summary=''):
        ...
        if active_approach == 21:
            prompt = f"""Task Description: You are given a list of feedback comments sourced from a survey for company named Demo Company, where the intent of the survey was get feedback.
                            ...
                            6. Language Style: Use professional and neutral language suitable for presentation to senior members.
                            Additional Notes:
                            - We have the quantitative summary of the survey: {quant_summary}. Include the quantitative data information in the summary which will be generated.
                            - We have a summary generated from our previous comments = {previous_summary}. Take this also in consideration while generating summary of current comments
                            - Pay attention to sentiment analysis to distinguish between positive and negative feedback.
                            - Include any specific issues or suggestions mentioned in the comments.
                            - Use natural language generation to create a coherent summary that reflects the general sentiment and concerns of the customers.
    ...
    def generate_final_summary_with_quant_data(self, previous_summary, quant_data_summary):
        prompt = f"""Task Description: You are given a final summary from comments sourced from a survey for company named Demo Company, where the intent of the survey was get feedback.
                        Your task is to generate a main summary by using the previous summary combining the quantitative data summary.
                        Input: A final summary of feedback comments and interactions with call center agents, provided as follows along with the summary of the quantitative data of the complete survey
                        previous summary = {previous_summary}
                        quantitative data summary = {quant_data_summary}                                                
                        Requirements:
                        1. Must include the quantitative data in the summary.
                        2. Summary Length: The summary should be concise but contain all important points mentioned in the feedback comments.
                        3. Key Points: Ensure that the summary captures key points of the feedback, including positive and negative aspects of the customer experience.
                        4. Clarity: The summary should be clear and understandable to senior members to get an overview of the feedback.
                        5. Contextual Understanding: The LLM should demonstrate an understanding of the context of banking, customer service, and common issues faced by customers.
                        6. Language Style: Use professional and neutral language suitable for presentation to senior members.
                        Additional Notes:
                        - Pay attention to quantitative data and focus more on that                        
                        - Use natural language generation to create a coherent summary that reflects the general sentiment and concerns of the customers.
                        - Ensure that the summary maintains confidentiality and doesn't disclose personal or sensitive information.
                        - Provide a clear structure to the summary, possibly dividing it into positive and negative aspects for easier understanding.
                        - Avoid redundancy and focus on highlighting unique aspects of the feedback.
                        Here is a sample summary for some other survey, make sure the new summary is similar:
                        Teleline's Eastern Region saw NPS drop precipitously since last period to an NPS score of 34 with 79% of respondents as detractors. While promoters provided feedback expressing satisfaction with our services and happiness with the quality of customer service they have received, feedback from detractors consistently surfaced complaints regarding the installation process. "Installing a product or service..." received the lowest satisfaction ratings of any point in the customer journey, with 56% of respondents indicating that they are very dissatisfied."""

        return prompt

    def generate_quant_data_summary_prompt(self, quant_data):
        prompt = f"""Task Description: You are given a quantitative data of the survey where the intent of the survey was get feedback.
                        Your task is to generate a summary of around 100 words by using this quantitative data.
                        Input quantitative data = {quant_data}. """

        return prompt

    def generate_quant_data_summary_with_key_objective_and_survey_type_prompt(self, quant_data, survey_type,
                                                                              key_metric):
        prompt = f"""Task Description: You are given a quantitative data of the survey where the intent of the survey was get feedback. The type of the survey is {survey_type} and key metric for the survey is  {key_metric}
                        Your task is to generate a summary of around 100 words by using this quantitative data.
                        Input quantitative data = {quant_data}. """
